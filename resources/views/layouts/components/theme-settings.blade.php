<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <div class="p-4">
                ...
                <div id="sidebar-visibility" class="d-none">
                ...
                <div id="layout-width" class="d-none">
                ...
                <div id="sidebar-size" class="d-none">
                ...
                <div id="sidebar-view" class="d-none">
    ...
    <div class="offcanvas-footer border-top p-3 text-center d-none">
        <div class="row">
            <div class="col-6">
