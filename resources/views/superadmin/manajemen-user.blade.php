    ...
    <script>
        ...
        function modalUser(id) {
            ...
            if (id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('superadmin-manajemen-user-detail') }}",
                    data: {
                        user_id: id
                    },
                    dataType: "json",
        ...
        function storeUser() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('superadmin-manajemen-user-store') }}",
                data: {
                    data: data_input
                },
                dataType: "json",
        ...
        function toRemove(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('superadmin-manajemen-user-delete') }}",
                        data: {
                            user_id: id,
                        },
                        dataType: "json",
        ...
        function confirmResetPwd(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('superadmin-manajemen-user-reset-password') }}",
                        data: {
                            user_id: id,
                        },
                        dataType: "json",
        ...
        function loadTable() {
            ...
            $('#table-user').DataTable({
                ...
                scrollX: true,
                ordering: false,
                ajax: "{{ route('superadmin-manajemen-user-data') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        function impersonate(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('superadmin-manajemen-user-impersonate') }}",
                        data: {
                            user_id: id,
                        },
                        dataType: "json",
        ...
        function sendAccount(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('superadmin-manajemen-user-send-account') }}",
                        data: {
                            user_id: id,
                        },
                        dataType: "json",
